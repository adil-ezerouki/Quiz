...
<body class="h-[100vh] relative">
    ...
    {{-- popup div for creating a new post --}}
                    ...
                    <div id="newpost"
                        ...
                        <div class="postAttatchements w-full flex flex-col gap-3">
                            ...
                            <div style="display: none" class="flex justify-center resetAllPostDataDiv">
                                <span id="resetAllPostData"
                                    class="px-3 py-2 cursor-pointer   bg-[#05b2b0] text-white rounded">Reset All</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex flex-col gap-1 text-xs w-full">
                                <span class="text-[16px] w-full flex flex-wrap gap-1">
                                    ...
                                    <span id="tagDisplay"
                                        ...
                                        <img style="display: none" src="{{ asset('images/tag.png') }}"
                                            alt="" srcset=""
                                    ...
                                    <span id="locationDisplay"
                                        class=" flex justify-center items-center  feelingSpan font-[100] text-slate-500 gap-1">
                                        <img style="display: none" src="{{ asset('images/location.png') }}"
                                            alt="" srcset=""
                                            class="tagANDlocalIcon cursor-pointer w-5 h-5">
                                        <span
                                            class="newPostDataDisplay text-slate-500 flex justify-center items-center gap-1">
    ...
    {{-- popup div for editing a post --}}

    <x-pop-up-div class="containerPopUpDivEditPost">
        <form action="{{ route('posts.store') }}" method="Post"
            class="biggestEditPostHolder relative flex flex-col  pt-0 w-[560px] h-[570px]"
            enctype="multipart/form-data">
            @csrf

            <i
                class="closeDivEditPost flex justify-center items-center fa-solid fa-x absolute w-10 h-10 right-2 top-2 bg-slate-200  rounded-full cursor-pointer"></i>

            <div class="progressDivEditPost bg-slate-700 w-[50%] h-2 rounded-t-lg rounded-r-lg mb-10 transition-all">
    ...
    {{-- alert for creation and deletion (posts,stories) --}}
